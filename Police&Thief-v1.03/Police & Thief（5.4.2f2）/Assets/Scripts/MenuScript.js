...
private var iMainMenuButtonsCount:int = 2;	//total number of buttons on main menu
//Pause Menu
...
private var iInstructionsButtonsCount : int = 3;
...
{
	if (Input.GetMouseButton(0))//detect taps
	{	
...
private function handlerInstructionsMenu(buttonTransform : Transform)
{
	...
	else if (tInstructionsButtons[1] == buttonTransform)//swipe controls
	{		
	...
	else if (tInstructionsButtons[2] == buttonTransform)
	{		
